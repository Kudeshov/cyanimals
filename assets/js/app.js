const translations = {
  ru: {
    ...
    about_title: 'О проекте', about_p1: 'На территории Республики Кипр регулярно совершаются акты насилия в отношении животных. Данные факты носят системный характер и свидетельствуют о глубоких социальных патологиях общества. Фиксируются случаи причинения животным боли, тяжких страданий и смерти. Собранные материалы (сообщения, фото-, видео- и документальные доказательства) используются для информирования общества и органов власти с целью привлечения виновных к ответственности. Насилие должно быть прекращено.',
  ...
  en: {
    ...
    contact_email_label: 'E-mail:',
    about_title: 'About the project', about_p1: 'Acts of violence against animals are regularly committed in the Republic of Cyprus. These incidents are systemic in nature and point to deep social pathologies within society. Cases are documented in which animals are subjected to pain, severe suffering, and death. Collected materials, including reports, photo, video, and documentary evidence, are used to inform the public and the authorities in order to hold those responsible accountable. The violence must be stopped.',
  ...
  el: {
    ...
    contact_email_label: 'E-mail:',
    about_title: 'Σχετικά με το έργο', about_p1: 'Στην Κυπριακή Δημοκρατία διαπράττονται τακτικά πράξεις βίας κατά των ζώων. Τα περιστατικά αυτά έχουν συστημικό χαρακτήρα και μαρτυρούν βαθιές κοινωνικές παθολογίες. Καταγράφονται περιπτώσεις πρόκλησης πόνου, βαριάς οδύνης και θανάτου στα ζώα. Το συγκεντρωμένο υλικό, συμπεριλαμβανομένων αναφορών, φωτογραφιών, βίντεο και τεκμηριωτικών αποδείξεων, χρησιμοποιείται για την ενημέρωση της κοινωνίας και των αρχών με στόχο την απόδοση ευθυνών στους υπαίτιους. Η βία πρέπει να σταματήσει.',
