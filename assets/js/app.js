const translations = {
  ru: {
    ...
    about_title: 'О проекте', about_p1: 'Проект посвящен документированию случаев стрельбы, отравлений и другого насилия против животных на Кипре.',
  ...
  en: {
    ...
    contact_email_label: 'E-mail:',
    about_title: 'About the project', about_p1: 'The project is dedicated to documenting incidents involving shootings, poisoning and other violence against animals in Cyprus.',
  ...
  el: {
    ...
    contact_email_label: 'E-mail:',
    about_title: 'Σχετικά με το έργο', about_p1: 'Το έργο είναι αφιερωμένο στην τεκμηρίωση περιστατικών πυροβολισμών, δηλητηριάσεων και άλλης βίας κατά ζώων στην Κύπρο.',
