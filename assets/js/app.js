const translations = {
  ru: {
    ...
    banner_slogan: 'ОСТАНОВИТЕ СТРЕЛЬБУ ПО ЖИВОТНЫМ',
    banner_line1: '3 мая, 18:00, Лимасол. Митинг в защиту животных, пострадавших от пуль.',
    banner_meeting: 'Место сбора: набережная в районе Enaerios, кафе Columbia Pier.',
    banner_action: 'Мы требуем расследования. Мы требуем защитить животных.',
  ...
  en: {
    ...
    contact_email_label: 'E-mail:',
    banner_slogan: 'Stop shooting animals',
    banner_line1: 'On May 3 at 18:00 in Limassol, an official protest will take place for animals shot and injured.',
    banner_meeting: 'Meeting point: Enaerios waterfront, Columbia Pier café.',
    banner_action: 'We demand a full investigation of incidents, protection for animals, and meaningful action against violence toward stray and owned animals.',
  ...
  el: {
    ...
    contact_email_label: 'E-mail:',
    banner_slogan: 'Σταματήστε να πυροβολείτε τα ζώα',
    banner_line1: 'Στις 3 Μαΐου, στις 18:00, στη Λεμεσό, πραγματοποιείται επίσημη διαμαρτυρία για ζώα που πυροβολήθηκαν και τραυματίστηκαν.',
    banner_meeting: 'Σημείο συνάντησης: Εναέριος, καφετέρια Columbia Pier.',
    banner_action: 'Απαιτούμε πλήρη διερεύνηση των περιστατικών, προστασία των ζώων και ουσιαστικά μέτρα απέναντι στη βία κατά των αδέσποτων και δεσποζόμενων ζώων.',
